...
const OccidenteComercio = () => {
  ...
  useEffect(() => {
    fetch(`${API_URL}/stores/region/5`)
      .then(res => res.json())
      .then(data => setStores(data));
  }, []);

  // Filtrar comercios por búsqueda
  ...
  const handleAdd = async (e) => {
    ...
    const res = await fetch(`${API_URL}/stores`, {
      ...
      body: JSON.stringify({ store_name: storeName, region_id: 5 }),
    });
...
export default OccidenteComercio;