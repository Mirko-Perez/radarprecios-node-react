        ...
        <div className="andes-container">
            ...
            <form className="andes-form" onSubmit={handleSubmit}>
                <Select
                    ...
                    isClearable
                    styles={{ container: base => ({ ...base, width: '100%', marginBottom: 10 }) }}
                />
                {brandId && (
                    <>
                        <input
...
export default OccidentePrecio;