...
const OrienteComercio = () => {
  ...
  const handleAdd = async (e) => {
    ...
    const res = await fetch(`${API_URL}/stores`, {
      ...
      body: JSON.stringify({ store_name: storeName, region_id: 6 }),
    });
...
export default OrienteComercio;